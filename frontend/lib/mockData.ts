...
export const mockMessages: Message[] = [
  {
    ...
    clientId: 'cl-1',
    campaignId: 'camp-1',
    content: 'Hi John! Welcome to our service. We\'re excited to have you on board.',
    status: 'DELIVERED',
  ...
  },
  {
    ...
    clientId: 'cl-2',
    campaignId: 'camp-1',
    content: 'Hi Jane! Welcome to our service. We\'re excited to have you on board.',
    status: 'SENT',
  ...
  },
  {
    ...
    clientId: 'cl-4',
    campaignId: 'camp-2',
    content: 'Alice, exclusive offer just for you! Use code SUMMER24 for 25% off.',
    status: 'DELIVERED',
